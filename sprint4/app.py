...
API_KEY = "lnGNzrv2bw-dDd4nlvW07gP2oG4W1XeWqDKt9_ScPkg1"
...
def predict():
    ...
    input_features = [int(blood_urea), int(blood_glucose_random), int(anemia), int(coronary_artery_disease),
                      int(pus_cell), int(red_blood_cell), int(diabetics_mellitus), int(pedal_edema)]
    ...
    payload_scoring = {"input_data": [{"field": [
        ['blood_urea', 'blood_glucose_random', 'anemia', 'coronary_artery_disease', 'pus_cell', 'red_blood_cell',
         'diabetics_mellitus', 'pedal_edema']], "values": features_value}]}

    response_scoring = requests.post(
        'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/f887afa8-65fa-40e0-849b-5b180653e583/predictions?version=2022-11-02',
    ...
    features_name = ['blood_urea', 'blood glucose random', 'anemia', 'coronary_artery_disease', 'pus_cell',
